...
function DashBoardPageNew() {
    return (
        <div className="w-screen h-screen relative flex justify-center items-center overflow-hidden">
            ...
            {/*</div>*/}
            <div className="flex items-center justify-evenly px-4 py-2 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-opacity-85 bg-base-300 rounded-lg border-2 border-solid border-neutral shadow-primary shadow-[0_0_5px]">
